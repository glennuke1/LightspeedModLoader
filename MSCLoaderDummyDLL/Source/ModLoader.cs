...
public partial class ModLoader : MonoBehaviour
{
    ...
    public static List<Mod> LoadedMods
    {
        get
        {
            return LightspeedModLoader.ModLoader.Instance.mscloadermodsloader.loadedMods;
        }
        set
        {
    ...
    public static void LoadModsSettings()
    {
        foreach (Mod mod in LightspeedModLoader.ModLoader.Instance.mscloadermodsloader.loadedMods)
        {
            LoadBinds();
            LoadSettings();
        }
    ...
    static void SaveModBinds(Mod mod)
    {
    ...
    static void SaveSettings(Mod mod)
    {
