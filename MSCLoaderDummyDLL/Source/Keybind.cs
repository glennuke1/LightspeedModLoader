...
public class Keybind
{
    ...
    public static void Add(Mod mod, Keybind key)
    {
        ...
        LML_Default_ModSettings.CustomSettings customSettings = LML_Default_ModSettings.ModSettings.GetModCustomSettings(mod);
        ...
        customSettings.AddKeybind(mod, key.ID, key.Name, key, key.Key, key.Modifier);
    }
    /// <summary>
    /// Add a keybind.
    /// </summary>
    ...
    public static Keybind Add(Mod mod, string id, string name, KeyCode key, KeyCode modifier)
    {
        ...
        customSettings.AddKeybind(mod, id, name, keyb, modifier, key);
